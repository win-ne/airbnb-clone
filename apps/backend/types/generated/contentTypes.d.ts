...
export interface ApiListingListing extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    amenities: Schema.Attribute.Component<'listing.amenity-type', true>;
    bathroomCount: Schema.Attribute.Integer & Schema.Attribute.Required;
    bedCount: Schema.Attribute.Integer & Schema.Attribute.Required;
    bedroomCount: Schema.Attribute.Integer & Schema.Attribute.Required;
    bookings: Schema.Attribute.Relation<'oneToMany', 'api::booking.booking'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    featuredServices: Schema.Attribute.Component<
      'listing.featured-services-type',
      true
    >;
    guestCount: Schema.Attribute.Integer & Schema.Attribute.Required;
    ...
    placeType: Schema.Attribute.Enumeration<['Entire Property', 'Room']> &
      Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    roomType: Schema.Attribute.Enumeration<['Studio', 'Multi-room']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
